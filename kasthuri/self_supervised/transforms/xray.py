...
from torchvision.transforms import ToTensor, RandomCrop, RandomErasing, RandomApply, ColorJitter, GaussianBlur, RandomAffine, Resize
...
class XrayAugmentationPipeline(nn.Module):
    ...
    def __init__(self, transform_name_list, name=None, image_size=IMAGE_SIZE, p = 0.5, same_on_batch=False, dataset_type="2D"):
        ...
        self.loccutmix = RandomLocalCutMix(2*image_size,2*image_size, cut_size = torch.tensor([0.15, 0.45]), p=p, dataset_type=dataset_type)
